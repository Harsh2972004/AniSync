const SkeletonCard = () => {
  return (
    <div className="max-h-[300px] xl:min-h-[450px] rounded-2xl p-[1px] bg-gradient-to-br from-transparent via-yellow-50 to-white">
      <div className="h-full w-full flex flex-col gap-3 bg-secondary rounded-2xl overflow-hidden p-2 pb-6">
        <div className="skeleton h-[150px] xl:h-[300px] overflow-hidden rounded-2xl" />
